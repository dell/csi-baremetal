...
func TestFSOperationsImpl_PrepareAndPerformMount_Fail(t *testing.T) {
	...
	// dst is exist, IsMountPoint failed
	dst = "/tmp"
	wrapFS.On("IsMountPoint", dst).Return(false, expectedErr).Once()
